...
class SingleViewController: UIViewController {
    ...
    private func initiatlize(){
        ...
        paperBotton.addTarget(self, action: #selector(moveToPickPaper), for: .touchUpInside)
        ...
        scissorsButton.addTarget(self, action: #selector(moveToPickScissors), for: .touchUpInside)
        ...
        rockButton.addTarget(self, action: #selector(moveToPickRock), for: .touchUpInside)
